...
session.setAttribute("CNum21", CNum2[selectnum2]);
session.setAttribute("CPId21", CPId2[selectnum2]);
%>
<body>
	<header id="header">
	...
	<nav>
		<ul>
			<li><a href="backend_studentConsultCancle.jsp">cancel your consultation</a></li>
		</ul>
	</nav>
</body>
</html>